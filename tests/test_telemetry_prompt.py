...
from ctxray.telemetry.prompt import maybe_prompt_consent


class TestMaybePromptConsent:
    def test_returns_false_when_already_opted_in(self, tmp_path: Path):
        from ctxray.telemetry.consent import write_consent
    ...
    @patch("ctxray.telemetry.prompt._ask_consent_rich")
