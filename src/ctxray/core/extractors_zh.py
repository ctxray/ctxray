# src/ctxray/core/extractors_zh.py
...
from ctxray.core.cost import estimate_tokens as _estimate_tokens
from ctxray.core.library import categorize_prompt
from ctxray.core.prompt_dna import PromptDNA
from ctxray.core.segmenter import PromptSegment, segment_prompt
...
def extract_features_zh(
    ...
    *,
    ...
    return PromptDNA(
        ...
        source=source,
        task_type=task_type,
        token_count=_estimate_tokens(text, "zh"),
