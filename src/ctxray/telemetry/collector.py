...
from ctxray.telemetry.events import build_event
...
def get_collector() -> TelemetryCollector:
    ...
    next to the main ctxray DB.
    """
    from ctxray.config import Settings, _default_config_path
...
def _get_version() -> str:
    """Get the current ctxray version."""
    try:
        from importlib.metadata import version

        return version("ctxray")
    except Exception:
        return "unknown"
